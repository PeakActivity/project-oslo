...
<body class="stretched">
	...
	<?php 
		include ('includes/platform/slider2.php');
	?>
	...
	<!-- Body Content -->
		...
		<?php 
			include ('includes/platform/content2.php');
			include ('includes/platform/pricing2.php');
			include ('includes/platform/connections2.php');
			include ('includes/platform/signup2.php');
		?>
    ...
    <?php include('includes/platform/footer2.php'); ?>
    <!-- common functions -->
