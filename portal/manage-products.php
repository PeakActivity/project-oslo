...
<body>
	...
	<div class="container" id="body-container">
        <div class="row">
            <div class="col-sm-3 pr-0" style="float:left">
                <!-- Nav tabs -->
                <ul class="config-left nav nav-pills flex-column" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#products" role="tab">Products</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#promotions" role="tab">Carousel Items</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#featured" role="tab">Featured Items</a>
                  </li>
                </ul>
            </div>
            <div class="col-sm-9 config-right">
                ...
                <div class="tab-content">
                  ...
                  <?php 
                    $aUsers = GetProductInfo($_SESSION['domain_id']);
                  ?>

                  </div>
                  <div class="tab-pane" id="promotions" role="tabpanel">Carousel Items</div>
                  <div class="tab-pane" id="featured" role="tabpanel">Featured Items</div>
                </div>
            </div>
        </div>
	</div>
