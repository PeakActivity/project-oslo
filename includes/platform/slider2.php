	        ...
	        <div class="row carousel-caption">
	        	<div class="col-xs-12 col-sm-8 offset-sm-2 col-md-6 offset-md-0 col-lg-5">
					...
					<div class="hidden-sm-down">
						<a href="#register" class="button button-desc button-border button-light button-rounded nomargin"><i class="fa fa-bullseye"></i><div>Start your Free Trial<span>30-Days &amp; No Credit card Required</span></div></a>
					</div>

					<div class="hidden-md-up">
						<a href="#register" class="button button-light button-xlarge button-rounded nomargin"><i class="fa fa-bullseye"></i>Start Free Trial</a>
					</div>
                </div>
	        </div>
	    </div>
	    <div class="carousel-item">
	        ...
	        <div class="row carousel-caption">
	        	<div class="col-xs-12 col-sm-8 offset-sm-2 col-md-6 offset-md-0 col-lg-5">
                    ...
                    <strong>Welcome to Oslo</strong></h1>
					<div class="hidden-sm-down">
						<button class="button button-desc button-border button-light button-rounded nomargin"><i class="fa fa-bullseye"></i><div>Start your Free Trial<span>30-Days &amp; No Credit card Required</span></div></button>
					</div>
