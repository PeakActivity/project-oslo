				...
				<div id="overview" class="container py-5 text-center">
					<div class="row">
						<div class="col-xs-12 col-sm-4 nobottommargin center">
						...
						<div class="col-xs-12 col-sm-4 nobottommargin center col_last">
				...
				<div id="features" class="section my-0 " style="padding-bottom: 50px;">
					<div class="container clearfix" style="z-index: 1;">
						<div class="row">
							<div class="col-xs-12 col-sm-6 mb-0">
								...
								<a href="#register" class="button button-border button-rounded button-large button-dark noleftmargin">Start Trial</a>
							</div>
	                        <div class="hidden-sm hidden-xs col-sm-6">
				...
				<div class="section my-0" style="padding-bottom: 150px;">
